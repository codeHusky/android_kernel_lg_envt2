...
#ifdef CONFIG_LGE_MCP_SETUP
	{0x5500B3AD, 0x0000FFFF, (1024<<20), 1, 2048, (2048<<6), 64, }, /*Hynx*/
	{0x5500BCAD, 0x0000FFFF, (512<<20), 1, 2048, (2048<<6), 64, }, /*Hynx*/
...
// no need to check ONFI, ONFI detection invokes "CRC Check failed on ONFI Parameter data"
#ifdef CONFIG_LGE_MCP_SETUP
