...
#include <mach/lg_sensors.h> // platform data
...
static struct early_suspend k3_early_suspend;
...
#if defined( CONFIG_LGE_SENSOR_KR3DM)
...
#ifdef CONFIG_HAS_EARLYSUSPEND
	k3_early_suspend.suspend = kr3dh_early_suspend;
	k3_early_suspend.resume = kr3dh_late_resume;
	k3_early_suspend.level = EARLY_SUSPEND_LEVEL_BLANK_SCREEN - 40;
	register_early_suspend(&k3_early_suspend);
#endif
...
{	
	...
	(void) kr3dh_disable(kr3dh_misc_data);
	return;
}
...
static void kr3dh_late_resume(struct early_suspend * h)
{
	...
	(void) kr3dh_enable(kr3dh_misc_data);
	return;
}
#else
...
static struct i2c_driver kr3dh_driver = {
	...
	.resume = NULL, //kr3dh_resume,
	.suspend = NULL, //kr3dh_suspend,
	.id_table = kr3dh_id,
};
