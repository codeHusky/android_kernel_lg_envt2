...
/* The following variables can be specified by module options */
 /* for copy buffer */
#if defined (CONFIG_LGE_DIAG_KERNEL_SERVICE) || defined (CONFIG_LGE_DIAG_UTS_SCREEN_SHOT) || defined (CONFIG_LGE_ATS_ETA_MTC)
...
spinlock_t diagchar_write_lock;
...
#else /*CONFIG_LGE_DIAG_KERNEL_SERVICE*/
/* This is the max number of user-space clients supported at initialization*/
static unsigned int max_clients = 15;
static unsigned int threshold_client_limit = 30;
#if 1//LGE_5035_PATCH
...
#endif /*CONFIG_LGE_DIAG_KERNEL_SERVICE*/
void *buf_hdlc;
...
#ifdef LG_DIAG_DEBUG
	printk(KERN_DEBUG "LG_FW : diagchar_read	fd data_ready\n");
#endif
	mutex_lock(&driver->diagchar_mutex);
