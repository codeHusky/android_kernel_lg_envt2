...
#define CAD_HW_DEVICE_ID_HEADSET_GSM_SPKR_STEREO	0x17
#define CAD_HW_DEVICE_ID_HANDSET_GSM_SPKR		0x18
#endif 

#ifdef CONFIG_LGE_AUDIO_CAD_ADD
#define CAD_HW_DEVICE_ID_SPKR_PHONE_REC_MIC		0x19
#endif 
...
#ifdef CONFIG_LGE_AUDIO_CAD_ADD
#define CAD_HW_DEVICE_ID_SPKR_PHONE_GSM_STEREO		0x26
#define CAD_HW_DEVICE_ID_SPKR_PHONE_VR_MIC 0x27
#define CAD_HW_DEVICE_ID_BT_VR_MIC 0x28
#endif 
...
static struct q6_device_info q6_audio_devices[] = {
	...
	{
		.id	= ADSP_AUDIO_DEVICE_ID_HEADSET_SPKR_MONO,
		.cad_id	= CAD_HW_DEVICE_ID_HEADSET_GSM_SPKR_STEREO,
		.path	= ADIE_PATH_HEADSET_STEREO_RX,
		.rate   = 48000,
		.dir	= Q6_RX,
		.codec	= Q6_ICODEC_RX,
	...
	{
		.id = ADSP_AUDIO_DEVICE_ID_HANDSET_SPKR,
		.cad_id = CAD_HW_DEVICE_ID_HANDSET_GSM_SPKR,
		.path	= ADIE_PATH_HANDSET_RX,
		.rate	= 48000,
		.dir	= Q6_RX,
		.codec	= Q6_ICODEC_RX,
...
#ifdef CONFIG_LGE_AUDIO_CAD_ADD
	{
		.id = ADSP_AUDIO_DEVICE_ID_SPKR_PHONE_REC_MIC,
		.cad_id = CAD_HW_DEVICE_ID_SPKR_PHONE_REC_MIC,
		.path	= ADIE_PATH_SPEAKER_TX,
		.rate	= 8000,
		.dir	= Q6_TX,
		.codec	= Q6_ICODEC_TX,
...
#ifdef CONFIG_LGE_AUDIO_CAD_ADD
	{
		.id = ADSP_AUDIO_DEVICE_ID_SPKR_PHONE_VR_MIC,
		.cad_id = CAD_HW_DEVICE_ID_SPKR_PHONE_VR_MIC,
		.path	= ADIE_PATH_SPEAKER_TX,
		.rate	= 8000,
		.dir	= Q6_TX,
		.codec	= Q6_ICODEC_TX,
	...
	{
		.id = ADSP_AUDIO_DEVICE_ID_SPKR_PHONE_STEREO,
		.cad_id = CAD_HW_DEVICE_ID_SPKR_PHONE_GSM_STEREO,
		.path	= ADIE_PATH_SPEAKER_STEREO_RX,
		.rate	= 48000,
		.dir	= Q6_RX,
		.codec	= Q6_ICODEC_RX,
...
#ifdef CONFIG_LGE_AUDIO_CAD_ADD
	{
		.id	= ADSP_AUDIO_DEVICE_ID_BT_VR_MIC,
		.cad_id	= CAD_HW_DEVICE_ID_BT_VR_MIC,
		.path	= 0, /* XXX */
		.rate   = 8000,
		.dir	= Q6_TX,
		.codec	= Q6_ECODEC_TX,
