...
// SMEM is limited to 512, so use from here
#ifdef CONFIG_LGE_MACH_ENVT2
	SMEM_LG_START = 450,
#endif

//this will be used in LK for trickle charging display
#ifdef CONFIG_LGE_BOOT_TRICKLE_CHARGING
	SMEM_TRICKLE_CHARGING_STATUS = SMEM_LG_START,
#endif
#ifdef CONFIG_LGE_FUEL_GAUGE_SOC
    SMEM_FUEL_GAUGE_SOC = 451,
#endif

//LG_FW : 2010.6.14 jaeho.cho@lge.com LT detection
#if defined (CONFIG_LGE_SMEM)
    SMEM_BOOT_MODE = 500,
    SMEM_PM_POWER_ON_STATUS = 501,
//LG_FW : 2010.6.14 jaeho.cho@lge.com LT detection
#if defined(CONFIG_LGE_USB_SUPPORT_SMEM_CABLE_TYPE)
    SMEM_LT_DETECT = 503,
#endif
    //LGE_UPDATE_S LGE_FOTA
#ifdef LGE_FOTA    
    SMEM_FOTA_BOOT_MODE = 507,
    SMEM_FOTA_PROGRASS = 508,
    SMEM_FOTA_LANGUAGE = 509,
#endif    
    //LGE_UPDATE_E LGE_FOTA
#if defined (CONFIG_LGE_MACH_ENVT2_CHECK_HW_REV)    
    SMEM_HW_PCB_REV = 510, //  // custfile_apply
#endif
#ifdef CONFIG_LGE_UART3_SUPPORT_FACTORY_POWER_INSPECTION
  SMEM_REMOTE_PWR_ON_FLAG = 511,
#endif
    SMEM_LG_LAST,
    SMEM_MEM_LAST = SMEM_LG_LAST,  
#else
...
#ifdef CONFIG_LGE_UART3_SUPPORT_FACTORY_POWER_INSPECTION
#define BOOT_UART_DIAG_M		0x987234BC
#endif
