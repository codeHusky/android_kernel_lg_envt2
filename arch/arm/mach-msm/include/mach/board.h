...
#if 1//defined (CONFIG_LGE_MACH_ENVT2)&& !defined(CONFIG_NEC_CE147)
...
/* LG_FW : 2010.04.01 jinho.jang */
#if defined(CONFIG_LGE_MACH_ENVT2)
/* gpio-i2c related functions */
void vs760_init_gpio_i2c_devices(void);


#ifdef CONFIG_LGE_TOUCHSCREEN_AVAGO_SPI
