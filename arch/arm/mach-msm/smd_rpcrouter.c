...
#if 1//LGE_5040_PATCH
#else
// case 345787 - Failure at dog report caused by rex waiting of rpc
#ifdef CONFIG_LGE_QCT_SBA
...
int msm_rpc_write(struct msm_rpc_endpoint *ept, void *buffer, int count)
{
	...
	struct rr_remote_endpoint *r_ept;
// case 345787 - Failure at dog report caused by rex waiting of rpc
#ifdef CONFIG_LGE_QCT_SBA //LGE_5040_PATCH - already applied
