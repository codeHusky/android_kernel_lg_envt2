...
//static int user_keypress =0;
 ...
 int LGE_ErrorHandler_Main( int crash_side, char (*message)[LGE_ERROR_MAX_COLUMN])
 {
...
int display_info_LCD( int crash_side, char (*message)[LGE_ERROR_MAX_COLUMN])
{
...
void expand_char_to_shrt(char (*message)[LGE_ERROR_MAX_COLUMN], unsigned short *buffer)
{
	char (*src)[LGE_ERROR_MAX_COLUMN] = message;
