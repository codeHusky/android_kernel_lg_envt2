...
#define AUDIO_START_LOOPBACK _IOW(AUDIO_IOCTL_MAGIC, 97, unsigned)
#define AUDIO_STOP_LOOPBACK _IOW(AUDIO_IOCTL_MAGIC, 98, unsigned)
// LGE_DOM_UPDATE_E jin333.kim@lge.com 2010/03/30 }
#endif 

#ifdef CONFIG_LGE_AUDIO_TUNNING
#define AUDIO_BOOT_START _IOW(AUDIO_IOCTL_MAGIC, 99, unsigned)
#endif 
